/*
  # Add timezone support and update transaction handling

  1. Changes
    - Add timezone columns to transactions table
    - Create data retention enforcement function
    - Create/update timezone handling trigger
    - Update transaction stats calculation function

  2. Security
    - Functions marked as SECURITY DEFINER
    - Safe SQL execution with proper escaping
*/
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 
    FROM pg_trigger 
    WHERE tgname = 'transaction_timezone_trigger'
  ) THEN
