/*
  ...
  1. New Tables
    - transactions: Stores all financial transactions with 4-decimal precision
    - transaction_stats: Stores statistical data for fraud detection
  
  2. Functions
    - calculate_transaction_stats: Calculates transaction statistics
    - update_transaction_stats: Trigger function for stats updates
