/*
  # Create FAQs table and related functions

  1. New Tables
    - `faqs` table for storing FAQ entries and their embeddings
...
DROP FUNCTION IF EXISTS update_faq_embedding CASCADE;
...
-- Drop existing function if it exists
DROP FUNCTION IF EXISTS match_faqs CASCADE;
