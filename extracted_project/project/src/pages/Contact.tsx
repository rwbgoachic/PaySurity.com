        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full h-11 px-6 text-base inline-flex items-center justify-center font-medium bg-blue-600 text-white border-2 border-blue-600 hover:bg-blue-700 hover:border-blue-700"
              >
                Send Message
              </button>
            </form>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:contact@paysurity.com" className="text-gray-600 hover:text-blue-600">
                      contact@paysurity.com
                    </a>
                  </div>
                </div>
                <div className="flex items-start">
