...
export class IoltaReconciliationTestService implements TestService {
  ...
  private async setupTestData(): Promise<void> {
    ...
    this.testReconciliationData.trustAccountId = account.id;
    this.testBankStatementData.trustAccountId = account.id;
    ...
    if (this.testAccountId) {
      ...
      await db.delete(ioltaReconciliations)
        .where(and(
          ...
          eq(ioltaReconciliations.trustAccountId, this.testAccountId)
        ));
      ...
      await db.delete(ioltaBankStatements)
        .where(and(
          ...
          eq(ioltaBankStatements.trustAccountId, this.testAccountId)
        ));
      ...
      await db.delete(ioltaTransactions)
        .where(and(
          ...
          eq(ioltaTransactions.trustAccountId, this.testAccountId)
        ));
    ...
    try {
      ...
      tests.push({
        ...
        passed: !!reconciliation && 
                ...
                reconciliation.trustAccountId === this.testAccountId,
        error: null,
  ...
  private async testReconciliationReport(): Promise<TestGroup> {
    ...
    try {
      ...
      tests.push({
        ...
        passed: !!clientReport && 
                clientReport.clientId === this.testClientId.toString() &&
    ...
    try {
      ...
      tests.push({
        ...
        passed: !!bankStatement && 
                ...
                bankStatement.trustAccountId === this.testAccountId,
        error: null,
