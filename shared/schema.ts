...
// Import and re-export schema definitions from other files
...
declare global {
  namespace Express {
    interface Request {
      portalUser?: any; // Will be LegalPortalUser
      portalSession?: any; // Will be LegalPortalSession
    }
  }
}
...
// User roles enum
export const userRoleEnum = pgEnum("user_role", ["super_admin", "sub_super_admin", "admin", "developer", "executive", "finance", "marketing", "employee", "employer", "parent", "child", "affiliate", "merchant"]);
