...
const RequestMoneyScreen = () => {
  ...
  const handleRequestMoney = () => {
    if (!selectedContact) {
      Alert.alert('Error', 'Please select a sender');
      return;
    }
  ...
  const renderContactItem = ({ item }: { item: Contact }) => {
    ...
    return (
      ...
      >
        ...
        {isSelected && <Icon name="check-circle" size={24} color={colors.secondary} />}
      </TouchableOpacity>
    );
  };
            ...
            >
              ...
              <Text
                style={[
                  ...
                  selectedContact?.id === contact.id && { color: colors.secondary },
                ]}
                numberOfLines={1}
              >
    ...
    >
      ...
      <ScrollView style={styles.content}>
        ...
        {selectedContact && (
          <View style={styles.selectedContactContainer}>
            <View style={styles.selectedContactHeader}>
              <Text style={styles.selectedContactLabel}>Requesting from:</Text>
            ...
            <View style={styles.selectedContactInfo}>
              {selectedContact.avatarUrl ? (
                ...
                <View style={[styles.selectedContactInitials, {backgroundColor: colors.secondary}]}>
        ...
        <View style={styles.noteContainer}>
          <Text style={styles.noteLabel}>What's it for? (Optional)</Text>
          <TextInput
          ...
          <View style={styles.reminderContainer}>
            <View style={styles.reminderTextContainer}>
              ...
              <Text style={styles.reminderDescription}>
                Automatically send a reminder if the request is not paid within 3 days
              </Text>
            </View>
            <Switch
              value={sendReminder}
              onValueChange={setSendReminder}
              trackColor={{ false: colors.gray4, true: `${colors.secondary}80` }}
              thumbColor={sendReminder ? colors.secondary : colors.white}
            />
          </View>
        )}
