...
export function WalletLayout({ children }: WalletLayoutProps) {
  ...
  const navigationItems = [
    { name: "Dashboard", href: "/wallet", icon: BarChart3 },
    { name: "My Wallets", href: "/wallet/wallets", icon: CreditCard },
    { name: "Transactions", href: "/wallet/transactions", icon: Clock },
    { name: "Savings", href: "/wallet/savings", icon: PiggyBank },
    { name: "Family Members", href: "/wallet/family", icon: Users },
  ...
  const isActive = (href: string) => {
    if (href === "/wallet" && location === "/wallet") return true;
    if (href !== "/wallet" && location.startsWith(href)) return true;
    return false;
  };
          ...
          <div className="flex items-center gap-4">
            <Link href="/">
              <a className="flex items-center">
                ...
                <span className="font-bold text-lg">PaySurity Wallet</span>
              </a>
            </Link>
            <Badge variant="outline" className="ml-4 hidden sm:inline-flex">
              <span className="text-xs font-normal">wallet.paysurity.com</span>
            </Badge>
          </div>
